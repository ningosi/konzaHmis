 ...
 */
package org.openmrs.module.konzaconfig.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.ConfigurationfortheKonzaprojectController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class ConfigurationfortheKonzaprojectController {
